...
# Define file paths
DATA_DIR = ".."
WATER_FILE = os.path.join(DATA_DIR, "water_a_centrum", "centrum_CombinedDataframe_SummedAveraged_withoutOutliers.csv")
WEATHER_FILE = os.path.join(DATA_DIR, "weather", "Weather_Bronderslev_20152022.csv")
OUTPUT_FILE = "centrum_water_weather_aligned.csv"

def align_data_centrum():
