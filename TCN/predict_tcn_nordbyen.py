"""
TCN Model Prediction Script for Nordbyen Heat Consumption Forecasting.

This script:
1. Loads the trained TCN model
...
def predict_next_horizon(
    ...
    """
    Load the trained TCN model and preprocessing state, and predict the next `n` hours.
    """
    print("=" * 70)
    print("TCN PREDICTION - NORDBYEN HEAT CONSUMPTION")
    print("=" * 70)
    ...
    # 5. Load the trained TCN model
    print("\n[5/6] Loading trained TCN model...")
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(DATA_DIR, "tcn_predictions_future_24h.csv")
