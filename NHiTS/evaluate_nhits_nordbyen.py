"""
NHiTS Model Evaluation Script for Nordbyen Heat Consumption Forecasting.
...
def evaluate_on_test_set(
    ...
    """
    Evaluate NHiTS model on test set using walk-forward validation.
    """
    print("=" * 70)
    print("NHiTS MODEL EVALUATION - TEST SET")
    print("=" * 70)
    ...
    for i in range(n_predictions):
        ...
        try:
            ...
            # Debug: Print available quantiles
    ...
    # Debugging PICP and MIW inputs
    print("Debugging PICP and MIW inputs")
    print(f"y_true: {all_actuals[:5]}")
    print(f"y_low: {all_predictions_low[:5]}")
    print(f"y_high: {all_predictions_high[:5]}")
...
if __name__ == "__main__":
    ...
    results_path = os.path.join(RESULTS_DIR, "nhits_evaluation_predictions.csv")
